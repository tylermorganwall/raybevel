...
#' @param bevel_end Default `1`. The ending point of the bevel along the curve, ranges between 0 and 1.
...
#' @param max_height Numeric vector. The maximum heights of each bevel, as measured from the initial height at the end of the previous bevel.
...
#'   max_height  = c(0.1, 0.2, 0.2, 0.2, 0.4),
#'   angle = 45,
