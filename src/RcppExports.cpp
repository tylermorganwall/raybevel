...
RcppExport SEXP _rayskeleton_convert_ss_to_polygons_rcpp(SEXP ssSEXP, SEXP numbercoresSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(convert_ss_to_polygons_rcpp(ss, numbercores));
...
RcppExport SEXP _rayskeleton_generate_offset_links_nodes_rcpp(SEXP ss_linksSEXP, SEXP ss_nodesSEXP, SEXP offsetsSEXP, SEXP return_polysSEXP, SEXP progressSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_rayskeleton_convert_ss_to_polygons_rcpp", (DL_FUNC) &_rayskeleton_convert_ss_to_polygons_rcpp, 2},
    {"_rayskeleton_generate_offset_links_nodes_rcpp", (DL_FUNC) &_rayskeleton_generate_offset_links_nodes_rcpp, 5},
